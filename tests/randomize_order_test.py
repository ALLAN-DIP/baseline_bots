...
class TestRandomizeDipnet:
    def test(self):
        ...
        # These following tests test the validity of orders generated by the randomizer
...
def valid_RTO(order: Tuple) -> bool:
    return len(order) == 2 and valid_unit(order[0]) and order[1] == 'RTO'
...
def valid_WVE(order: Tuple) -> bool:
    return len(order) == 2 and order[0] in ADJACENCY and order[1] == 'WVE' 
