...
class TestUtils:
    def test(self):
        ...
        # These following two tests ensure that the valid values are being returned when calling random_orders with a seed.

        orders = [(("FRA", "FLT", "NTH"), "CVY", ('FRA', 'AMY', 'HOL'), 'CTO', "NWY"), (("FRA", "AMY", "HOL"), "CTO", 'NWY',"VIA", ('NTH'))]
        random.seed(1)
        assert random_orders(orders) == [(('FRA', 'FLT', 'NTH'), 'MTO', 'DEN'), (('FRA', 'AMY', 'HOL'), 'MTO', 'NTH')]

        orders = [(("FRA", "FLT", "NTH"), "CVY", ('FRA', 'AMY', 'HOL'), 'CTO', "NWY"), (("FRA", "AMY", "HOL"), "CTO", 'NWY',"VIA", ('NTH'))]
        random.seed(15)
        assert random_orders(orders) ==[(('FRA', 'FLT', 'NTH'), 'HLD'), (('FRA', 'AMY', 'HOL'), 'MTO', 'BEL')]
